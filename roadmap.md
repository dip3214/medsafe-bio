...
- [x] Revert MedBuddy cards added to Dashboard + Lifestyle (superseded by side panel)
- [x] Extract ChatWindow from chat.tsx into shared src/components/MedBuddyChat.tsx
- [x] Build MedBuddySide: right-edge floating button + slide-over chat panel (auth-aware; sign-in prompt when logged out)
